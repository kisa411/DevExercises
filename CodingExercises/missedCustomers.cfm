<cftry>
	...
	(
		select x.frn_calllog_aniid as missed, y.frn_calllog_aniid as returned, x.tz_datetime as missed_tz, y.tz_datetime as returned_tz, xd.frn_dnisfunctionid
	...
	<cfdump var='#outbound#'>
	<cfoutput>
		<cfset customers = #outbound.MissedCustomers#>
		<cfset outbound = #outbound.OutboundReturns#>
